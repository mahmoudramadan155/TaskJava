...
//        }
        ...
        PassengerProviderTest pProviderTest = new PassengerProviderTest ();
        ...
        TestData = TestData.merge (IntVector.of ("PClassValues",
                encodeCategory1 (TestData, "Pclass")));
        ...
        Arrays.stream(model.predict(TestData)).forEach(System.out::println);

//        var pred = model.predict(TestData);
//        System.out.println(Accuracy.of(TestData.column("PClassValues").toIntArray(), pred));
...
//            model1.metrics();
    ...
    public static int[] encodeCategory1(DataFrame df, String columnName) {
        int[] pclassValues = df.intVector (columnName).toIntArray ();
        return pclassValues;
    }
